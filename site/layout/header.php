    ...
    <header>
        ...
        <div class="top-navbar container-fluid">
            <div class="menu-mb">
                ...
                <a class="<?= $a == 'deliveryPolicy' ? 'active' : '' ?>" href="?c=information&a=deliveryPolicy">Chính sách giao hàng</a>
                ...
                <div class="col-lg-4 col-md-4 hotline-search">
                    <div>
                        <p class="hotline-phone"><span><strong>Hotline: </strong><a
                                    href="tel:0932.538.468">0901.425.912</a></span></p>
                        <p class="hotline-email"><span><strong>Email: </strong><a
                                    href="mailto:nguyenhuulocla2006@gmail.com">quanglauang@gmail.com</a></span>
                        </p>
                    </div>
